      ...
      {climbs.length > 0 && (
        <div className="grid grid-cols-2 gap-2">
          {sends > 0 && (
            <Badge
              variant="outline"
              className="border-green-200 text-green-700 justify-center py-2"
            >
          ...
          {attempts > 0 && (
            <Badge
              variant="outline"
              className="border-orange-200 text-orange-700 justify-center py-2"
            >
          ...
          {flashes > 0 && (
            <Badge
              variant="outline"
              className="border-blue-200 text-blue-700 justify-center py-2"
            >
          ...
          {onsights > 0 && (
            <Badge
              variant="outline"
              className="border-purple-200 text-purple-700 justify-center py-2"
            >
