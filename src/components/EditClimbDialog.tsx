...
const EditClimbDialog = ({
  ...
  const handleSave = () => {
    const updates: Partial<LocalClimb> = {
      ...
      physicalSkills:
        formData.physicalSkills.length > 0
      ...
      technicalSkills:
        formData.technicalSkills.length > 0
          ...
          : undefined,
      timestamp: (() => {
        const [year, month, day] = formData.timestampDate
          .split("-")
          .map(Number);
      ...
      <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          {formData.tickType === "attempt" && (
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData((prev) => ({ ...prev, attempts: Number(value) }))
                }
              >
                <SelectTrigger>
                  <SelectValue />
          ...
          <SkillsSelector
            ...
            onPhysicalSkillsChange={(skills) =>
              setFormData((prev) => ({ ...prev, physicalSkills: skills }))
            }
            onTechnicalSkillsChange={(skills) =>
